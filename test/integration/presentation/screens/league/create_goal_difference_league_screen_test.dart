...
void main() {
  ...
  setUpAll(() {
    registerFallbackValue(GoalDifferenceRankingPolicy(
      id: '',
      name: '',
      leagueId: '',
      pointsForWin: 3,
            ...
            body: Center(
              child: ElevatedButton(
                onPressed: () => Navigator.of(context).push(
                  MaterialPageRoute(
                    builder: (_) => const CreateGoalDifferenceLeagueScreen(),
                  ),
                ),
  ...
  group('CreateGoalDifferenceLeagueScreen', () {
    testWidgets('should show create goal difference league screen with form',
        (tester) async {
    ...
    testWidgets('should create league successfully with valid input',
      ...
      expect(call['rankingPolicy'], isA<GoalDifferenceRankingPolicy>());
      final policy = call['rankingPolicy'] as GoalDifferenceRankingPolicy;
    ...
    testWidgets('should use default scoring values when not changed',
      ...
      final policy = fakeLeaguesNotifier.addLeagueCalls.first['rankingPolicy']
          as GoalDifferenceRankingPolicy;
      expect(policy.pointsForWin, 3);
      expect(policy.pointsForDraw, 1);
      expect(policy.pointsForLoss, 0);
    });
