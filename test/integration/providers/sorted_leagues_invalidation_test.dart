...
void main() {
  setUpAll(() {
    ...
    registerFallbackValue(SimpleRankingPolicy(id: '', name: '', leagueId: '', categoryIds: const ['cat_custom_league_001']));
  ...
  final tPolicy1 =
      SimpleRankingPolicy(id: 'rp1', name: 'Standard', leagueId: 'l1', categoryIds: const ['cat_custom_league_001']);
  ...
  group('SortedLeaguesProvider explicit invalidation graph (R7)', () {
    test('leagues addLeague invalidates sortedLeaguesProvider', () async {
      ...
      await container.read(leaguesProvider.notifier).addLeague(
          ...
          name: 'Gamma',
          rankingPolicy:
              SimpleRankingPolicy(id: 'rp3', name: 'S', leagueId: 'l3', categoryIds: const ['cat_custom_league_001']));
