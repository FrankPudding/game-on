...
class CreateGoalDifferenceLeagueScreen extends ConsumerStatefulWidget {
  ...
  ConsumerState<CreateGoalDifferenceLeagueScreen> createState() =>
      _CreateGoalDifferenceLeagueScreenState();
}

class _CreateGoalDifferenceLeagueScreenState
    extends ConsumerState<CreateGoalDifferenceLeagueScreen> {
  ...
  Future<void> _createLeague() async {
    ...
    try {
      ...
      RankingPolicy rankingPolicy = GoalDifferenceRankingPolicy(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('New Goal Difference League')),
